...
function printSaleReceipt(groupId){
  // No celular, usar um único PDF evita duas prévias de impressão (A4 + compacto).
  ...
  openPdfFromLines(lines,"pedido-"+String(groupId).slice(0,8)+".pdf",{width:226.77,height:566.93,fontSize:9,leading:13,left:18,top:540,maxChars:34});
}
