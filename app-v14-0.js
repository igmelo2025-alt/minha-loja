...
});if(!r.ok)throw new Error(await r.text());alert("Conexão com a nuvem funcionando!")}catch(e){console.error(e);alert("A conexão falhou. Confira a URL, a chave anon e o SQL/RLS da tabela app_backups.")}}
